...
exports.passportGeneralCallback = function callback (accessToken, refreshToken, profile, done) {
  ...
  if( profile.emails[0].value != "edoubuntu@gmail.com" && profile.emails[0].value!= "mirko.maischberger@gmail.com" ){
      return done(null, false, { message: "Sorry, you're not in the list." });
  }
